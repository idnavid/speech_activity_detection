...
#b) UTD cluster options
export train_cmd="queue.pl -q all.q@compute-0-[123456]"
export decode_cmd="queue.pl -q all.q@compute-0-[123456]"
export mkgraph_cmd="queue.pl -q all.q@compute-0-[123456]"
export cuda_cmd=run.pl
